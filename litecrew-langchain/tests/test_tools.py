...
class TestDelegationTool:
    ...
    def test_delegation_tool_creation(self):
        ...
        agent1 = LiteAgent(
            role="Researcher", goal="Research things", backstory="I research"
        )
        agent2 = LiteAgent(role="Writer", goal="Write things", backstory="I write")
    ...
    def test_delegation_success(self):
        ...
        role, task = tool_class._parse_delegation(
            "Ask the Researcher to find information about AI"
        )
