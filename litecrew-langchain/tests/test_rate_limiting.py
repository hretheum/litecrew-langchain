...
from litecrew.rate_limiter import GlobalRateLimiter, RateLimiter, TokenCounter
...
class TestGlobalRateLimiter:
    ...
    def test_per_agent_limits(self):
        ...
        global_limiter = GlobalRateLimiter(
            max_rpm=6000, per_agent_limits={"fast_agent": 3600, "slow_agent": 600}
        )

        fast_agent = Mock(name="fast_agent")
        Mock(name="slow_agent")
...
class TestBudgetLimits:
    ...
    def test_budget_alerts(self):
        ...
        budget_manager = BudgetManager(
            daily_limit=10.0, alert_threshold=0.8, alert_callback=alert_callback
        )
