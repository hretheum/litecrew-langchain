...
class MemorySummarizer:
    ...
    def summarize(
        ...
        target_length = int(self._calculate_total_length(turns) * self.compression_ratio)
    ...
    def estimate_summary_quality(self, summary: str, original_turns: List[Dict[str, Any]]) -> float:
        """
