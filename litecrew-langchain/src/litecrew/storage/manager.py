...
class StorageManager:
    ...
    def get_result(self, key: str, version: Optional[int] = None) -> Optional[Dict[str, Any]]:
        """
    ...
    async def astore_result(self, result: Dict[str, Any], key: Optional[str] = None) -> str:
    ...
    async def aget_result(self, key: str, version: Optional[int] = None) -> Optional[Dict[str, Any]]:
