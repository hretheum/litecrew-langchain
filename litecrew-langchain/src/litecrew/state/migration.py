...
class MigrationChain:
    ...
    def find_migration_path(self, from_version: str, to_version: str) -> List[StateMigration]:
    ...
    def apply_migrations(self, state: Dict[str, Any], from_version: str, to_version: str) -> Dict[str, Any]:
