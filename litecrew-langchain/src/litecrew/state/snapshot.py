...
class StateSnapshot:
    ...
    @classmethod
    def create(cls, state: CrewState, version: int = 1, 
               compress: bool = False, metadata: Optional[Dict[str, Any]] = None) -> 'StateSnapshot':
        ...
        if compress:
            ...
            compressed_data, _, _ = Compressor.compress(
                data_str, 
