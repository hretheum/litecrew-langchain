...
class StateManager:
    ...
    def save_incremental_update(self, state: CrewState, changed_fields: List[str]) -> str:
        """
    ...
    def load_state(self, crew_id: str, version: Optional[int] = None) -> Optional[CrewState]:
        """
    ...
    def _apply_incremental_updates(self, state: CrewState, base_version: int) -> CrewState:
