...
class CacheWarmer:
    ...
    async def _warm_single_key(self, key: str, compute_func: Callable, level: int) -> None:
        """Warm a single key."""
        try:
    ...
    def schedule_warming(self, warming_func: Callable[[], None], 
    ...
    def warm_from_patterns(self, patterns: List[str], 
                          data_source: Callable[[str], Any]) -> int:
        """
