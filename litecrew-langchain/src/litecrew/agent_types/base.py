...
class AgentType(ABC):
    ...
    def __init__(self, config: AgentTypeConfig):
        self.config = config
        self.personality = config.default_personality or self._create_default_personality()
    ...
    def validate_response(self, response: str) -> bool:
        ...
        if self.config.min_response_length and len(response) < self.config.min_response_length:
            return False
