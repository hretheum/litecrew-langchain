...
class MetricsCollector:
    ...
    def track_agent_task(self, agent_name: str, task_type: str, status: str, duration: float):
...
class CostTracker:
    ...
    def add_usage(self, provider: str, model: str, prompt_tokens: int, completion_tokens: int):
